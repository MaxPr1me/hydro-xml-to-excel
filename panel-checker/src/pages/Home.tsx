  ...
  return (
    <main className="mx-auto max-w-5xl space-y-6 px-4 py-10">
      <section className="rounded-3xl bg-gradient-to-br from-brand-600 to-slate-900 p-8 text-white shadow-lg">
        ...
        <h1 className="mt-3 text-3xl font-bold">Check if a home's electrical panel has room for other electrical loads.</h1>
        <p className="mt-3 max-w-2xl text-base text-brand-100">
          Upload interval data, validate cadence and units, graph the demand, and run a friendly calculator to see if another
          electrical load such as a heat pump can be added.
        </p>
      </section>
